...
import com.jmg.checkagro.provider.events.CrearProviderEvent;
...
public class ProviderService {
    ...
    private final CrearProviderEvent crearProviderEvent;

    public ProviderService(ProviderRepository providerRepository, CheckMSClient client, CrearProviderEvent crearProviderEvent) {
        this.providerRepository = providerRepository;
        this.client = client;
        this.crearProviderEvent = crearProviderEvent;
    }
    ...
    public Long create(Provider entity) throws ProviderException {
        ...
        crearProviderEvent.publishCrearProvider(entity);
